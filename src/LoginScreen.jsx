    ...
    <div style={{ position: 'relative', display: 'flex', height: '100vh', width: '100vw', alignItems: 'center', justifyContent: 'center', background: '#000', color: 'var(--ink)', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 10 }}>
        <div className="login-container" style={{ padding: '40px', maxWidth: 450 }}>
          <div className="login-heading" style={{ marginBottom: 12 }}>Welcome to V-Lab</div>
          ...
          <div className="login-form">
            <div style={{ marginBottom: 24 }}>
              <div style={{ fontSize: 12, fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', marginBottom: 12, letterSpacing: '0.05em' }}>New Users Only:</div>
              {role === 'student' && (
                <>
              ...
              <div style={{ fontSize: 11, color: '#94a3b8', fontStyle: 'italic', marginTop: 8 }}>
                If you already have an account, these fields will be ignored.
              </div>
            </div>
            <button 
              type="button" 
