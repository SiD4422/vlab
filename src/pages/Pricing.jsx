      ...
      <div style={{ padding: '0 24px 48px' }}>
        <div style={{ maxWidth: 1080, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 36 }}>
            <div style={{ fontSize: 11, fontWeight: 800, color: '#8b5cf6', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 10 }}>
              What Faculty Say
            </div>
            <h2 style={{ fontSize: 'clamp(22px, 3vw, 32px)', fontWeight: 800, color: '#fff', margin: 0, letterSpacing: '-0.02em' }}>
          ...
          <div style={{ display: 'flex', gap: 20, flexWrap: 'wrap', justifyContent: 'center' }}>
            {[
              {
                quote: "V-Lab has completely transformed how my students approach lab sessions. The AI viva grading saves me hours every week, and the reports are NBA-ready out of the box.",
                name: "Dr. R. Subramaniam",
                role: "HOD, Dept. of EEE",
                institution: "Early Access Partner",
                initials: "RS",
                color: '#8b5cf6',
              },
              {
                quote: "The Wheatstone Bridge simulation is more detailed than our actual hardware setup. Students can run 100 trials in the time it takes to set up one physical circuit.",
                name: "Prof. A. Krishnan",
                role: "Lab In-Charge, ECE",
                institution: "Early Access Partner",
                initials: "AK",
                color: '#38bdf8',
              },
              {
                quote: "As an HOD, the anti-cheat analytics and submission dashboard give me visibility I never had before. This is exactly what modern engineering education needs.",
              ...
              <div key={i} style={{
                ...
                onMouseEnter={e => { e.currentTarget.style.borderColor = `rgba(${t.color === '#8b5cf6' ? '139,92,246' : t.color === '#38bdf8' ? '56,189,248' : '16,185,129'},0.4)`; e.currentTarget.style.transform = 'translateY(-3px)'; }}
                onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(255,255,255,0.07)'; e.currentTarget.style.transform = 'none'; }}
              >
                {/* Quote mark */}
                <div style={{ fontSize: 48, lineHeight: 1, color: t.color, opacity: 0.3, fontFamily: 'Georgia, serif', marginTop: -8 }}>"</div>
                <p style={{ fontSize: 14, color: '#cbd5e1', lineHeight: 1.7, margin: 0, marginTop: -24 }}>
                  {t.quote}
                </p>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginTop: 'auto', paddingTop: 16, borderTop: '1px solid rgba(255,255,255,0.06)' }}>
                  <div style={{
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 12, color: '#64748b' }}>{t.role} · {t.institution}</div>
                  </div>
                </div>
              </div>
            ))}
