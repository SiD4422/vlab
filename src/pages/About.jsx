...
export default function About() {
  ...
  return (
    <div style={{ background: C.ink, minHeight: "100vh", color: C.canvas, fontFamily: "ui-sans-serif, system-ui, -apple-system, sans-serif", overflowX: "hidden" }}>
      ...
      {/* Navbar */}
      <nav style={{ padding: "20px 40px", display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: `1px solid ${C.shellSoft}`, background: "rgba(18, 24, 38, 0.8)", backdropFilter: "blur(12px)", position: "sticky", top: 0, zIndex: 50 }}>
      ...
      <section style={{ padding: "100px 20px", textAlign: "center", position: "relative" }}>
        <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: "100%", height: "100%", background: `radial-gradient(circle at 50% 50%, ${C.teal}15 0%, transparent 50%)`, zIndex: 0, pointerEvents: "none" }} />
      ...
      {/* Features Grid */}
      <section style={{ padding: "80px 20px", background: C.shell, borderTop: `1px solid ${C.shellSoft}`, borderBottom: `1px solid ${C.shellSoft}` }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 30 }}>
            <FeatureCard 
              icon={<Zap size={32} color={C.copper} />}
            ...
            />
            <FeatureCard 
              icon={<Globe size={32} color={C.teal} />}
            ...
            />
            <FeatureCard 
              icon={<Code size={32} color="#8b5cf6" />}
